...
function Social({ magentou, linkedin, cv, email, skype, calendy, commercehero, stackoverflowstory, stackoverflowcv, stackexchange, twitter, github, dockerhub, pagespeed, lighthouse }) {
  return (
    <Wrapper>
      {magentou && (
      ...
      {cv && (
          <SocialLink href={cv} target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      {stackoverflowstory && (
          <SocialLink href={stackoverflowstory} target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      {stackoverflowcv && (
          <SocialLink href={stackoverflowcv} target="_blank" rel="noopener">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
